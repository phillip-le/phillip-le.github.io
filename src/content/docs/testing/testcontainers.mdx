...
the process of spinning of new containers is still too slow to spin up a new container for each individual test within a given test file.
So you're usually better off clearing the data in your database between individual tests.

For example, I clear all the data in my `Users` table after each test.
