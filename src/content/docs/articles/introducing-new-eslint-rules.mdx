...
Here's a list of some recommended configs:

- [eslint:recommended](https://www.npmjs.com/package/@eslint/js). A recommended set of rules native to ESLint.
- [typescript-eslint/recommended-type-checked](https://typescript-eslint.io/users/configs#recommended-type-checked). A recommended set of rules for TypeScript for code correctness.
- [typescript-eslint/stylistic-type-checked](https://typescript-eslint.io/users/configs#stylistic-type-checked). A recommended set of rules for TypeScript for simpler code patterns.
- [jest/recommended](https://www.npmjs.com/package/eslint-plugin-jest). A recommended set of rules for [jest](https://jestjs.io/).
- [vitest/recommended](https://www.npmjs.com/package/eslint-plugin-vitest). A recommended set of rules for [vitest](https://vitest.dev/).
- [unicorn/recommended](https://www.npmjs.com/package/eslint-plugin-unicorn). A large collection of miscellaneous rules.
- [eslint-plugin-testing-library](https://github.com/testing-library/eslint-plugin-testing-library). A collection of rules for [Testing Library](https://testing-library.com/).
...
which sparked my interest. I have been using [GitHub Copilot](https://github.com/features/copilot) for a while now
but one of the limitations with Copilot has been that I cannot use it programmatically.
